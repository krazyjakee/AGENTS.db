      ...
      <div class="modal-box max-w-2xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div class="alert alert-info">
            ...
            <div class="text-sm">
              <p class="font-semibold">Promotion creates a copy in the target layer.</p>
              <p class="mt-1">The original chunk remains in <span class="mono text-xs">{selectedLayer}</span></p>
            </div>
          </div>
